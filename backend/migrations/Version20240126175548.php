 ...
 */
final class Version20240126175548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE review (id INT NOT NULL, car_id INT NOT NULL, rate SMALLINT NOT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
